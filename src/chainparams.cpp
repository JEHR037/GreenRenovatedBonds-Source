 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1619717111, nBits=1e0ffff0, nNonce=1545804, vtx=1)
...
{
    const char* pszTimestamp = "A new green concept  27 april 2021";
    const CScript genesisOutputScript = CScript() << ParseHex("0423485257f8f035307f86d3846658bd3a88869f8101bc4cdbe32f43965bf418203141cdfedbbed5527a2effdfc2bee87e94081c224007c1c60dfe04a2a13da89f") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000db9f93e1634bb6da6743ea41b27e07ae3067ff340a5e760df6a2c05bf40"); 
        ...
        vAlertPubKey = ParseHex("040e6f1bffe03de79c1466a93909560fddae8ddcd363302b0c5f76a67296bfe6b255a24907cce947cc1db08f56655ee42dbdd0736d53998e2ee64b71d446f747bf");
        nDefaultPort = 34168;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1619717111, 1545804, 0x1e0ffff0, 1, 50 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000db9f93e1634bb6da6743ea41b27e07ae3067ff340a5e760df6a2c05bf40"));
        assert(genesis.hashMerkleRoot == uint256S("0x1d6b86850bd04d2f79f677b4942f1fab5e39279b4bf8c3abb7471cd2a2b4c237"));
        ...
        vSporkAddresses = {"GY7LmmXASGZNA1BNAzNQazckAtikbSM528"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x00000db9f93e1634bb6da6743ea41b27e07ae3067ff340a5e760df6a2c05bf40"))
        };

        chainTxData = ChainTxData{
            1619717111, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000006e874c9912c355b3406d9b3afff13192aafa0df6a1d7cc94878a9309b59"); 

        pchMessageStart[0] = 0x8a;
        pchMessageStart[1] = 0x06;
        pchMessageStart[2] = 0x38;
        pchMessageStart[3] = 0xca;
        vAlertPubKey = ParseHex("04fd48867c9d7fa4fc6b663e4935eba3c2240984a6c3296eeaa0a157f5d562990b7d17f3f883b006431ad273b8c1c64d2e010050cd272942fb52ffebb15913cd28");
        nDefaultPort = 44168;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1619717116UL, 3871856UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000006e874c9912c355b3406d9b3afff13192aafa0df6a1d7cc94878a9309b59"));
        assert(genesis.hashMerkleRoot == uint256S("0x1d6b86850bd04d2f79f677b4942f1fab5e39279b4bf8c3abb7471cd2a2b4c237"));
        ...
        vSporkAddresses = {"GP9E2Wc8dyWxsqXmLLWjP6KLKjfrmue9KQ"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x000006e874c9912c355b3406d9b3afff13192aafa0df6a1d7cc94878a9309b59"))
        };

        chainTxData = ChainTxData{
            1619717116, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1619717121, 3, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x5b1936f96b26a0fb71494dc542097e8856092194cc18cdb63637046a2d9250f5"));
        assert(genesis.hashMerkleRoot == uint256S("0x1d6b86850bd04d2f79f677b4942f1fab5e39279b4bf8c3abb7471cd2a2b4c237"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("greenrenovatedbondsevo.org",  "devnet-seed.greenrenovatedbondsevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x5b1936f96b26a0fb71494dc542097e8856092194cc18cdb63637046a2d9250f5"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 6aVpW4U8xzbzRdUa1GriK3CZpxU2mhjkfJY1V9va4LJqWmzwNBW
        vSporkAddresses = {"GNrE6pDgEv1ce4Yet63MDFU93izttcAePu"};
        nMinSporkKeys = 1;
